...
#region Animations
	...
	void AnimationGameOverOn()
	{
		...
		LeanTween.move(_gameOverChildrenPanel, new Vector2(0, _gameOverPanel.transform.position.y), .5f)
	...
	void AnimationPausePanelOn()
	{
		...
		LeanTween.move(_pauseChildrenPanel, new Vector2(0, _pausePanel.transform.position.y), .5f)
			.setEase(LeanTweenType.easeInOutSine).setIgnoreTimeScale(true);
	}
	...
	void AnimationGameOverOut()
	{
		...
		LeanTween.move(_gameOverChildrenPanel, new Vector2(0, _gameOverPanel.transform.position.y + 20f), .5f)
			.setEase(LeanTweenType.easeInOutSine).setIgnoreTimeScale(true);
	}
	...
	void AnimationPausePanelOut()
	{
		...
		LeanTween.move(_pauseChildrenPanel, new Vector2(0, _pausePanel.transform.position.y - 10f), 0.5f)
			.setEase(LeanTweenType.easeInOutSine).setIgnoreTimeScale(true);
